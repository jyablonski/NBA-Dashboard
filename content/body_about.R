      ...
      column(
        box(
          ...
          column(
            ...
            tags$br(),
            h3("ELT Pipeline"),
            HTML("A Python Docker Image performs the webscrape process via ECS Fargate everyday at 6:00 AM CST, and stores the data to an RDS MySQL Server."),
            tags$br(),
            tags$br(),
            tags$a(href = "https://github.com/jyablonski/python_docker", "Python Docker Image"),
            tags$br(),
            tags$a(href = "https://github.com/jyablonski/aws_terraform", "AWS Infrastructure via Terraform"),
            tags$br(),
            tags$a(href = "https://github.com/jyablonski/NBA-Dashboard", "R Shiny"),
            tags$br(),
            tags$br(),
            h3("Developer"),
            "Jacob Yablonski | ",
